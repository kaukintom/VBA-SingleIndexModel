...
# VBA Macros
 Module: Collect_Stock_Data, Sub Procedure: TickerDataCollect
 ...
 - Drawback: Currently uses a fixed 5 second delay per a security to allow the csv to open and display the data
  - Time consuming
 Module: Portfolio, Sub Procedure: OLSRegression
